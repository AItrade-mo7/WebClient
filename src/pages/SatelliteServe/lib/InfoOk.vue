...
<template>
  <div class="InfoOk" v-if="props.WssData.DataSource">
    ...
    <ol>
      ...
      <li>将你的 USDT 都划转到 OKX 【交易账户】下。</li>
      <li>用 OKX交易所 手动下单BTC合约 , 然后返回本系统【查看详情】，是否正常展示你的持仓</li>
      <li>点击【查看详情】选择一个策略【更新参数】</li>
      <li>进入详情，点击【清除所有仓位】</li>
      <li>返回交易所确认刚刚开的仓位是否被清除</li>
      <li>进入你的 APIKey 详情继续测试【开多】和【开空】按钮，确认是否可以通过系统顺畅完成 OKX 账户的下单操作。</li>
      <li>刷新页面，确认策略选择和杠杆倍数没问题。。</li>
      <li>策略会在市场转变时，自动同步你的持仓。躺着等收钱（或者亏完[笑]）</li>
